...
loop do
	...
	puts "=============================================================================================================="
	puts "Where are we having an encounter?"
	puts "--------------------------------------------------------------------------------------------------------------"
	puts "1.  St. Mary's Hospital        2.  Woods                3.  Ye Olde Magick Shoppe".colorize(:red)
	puts "4.  Curiositie Shoppe          5.  Newspaper            6.  Train Station".colorize(:light_red)
	puts "7.  Administrative Building    8.  Library              9.  Science Building".colorize(:light_yellow)
	puts "10. River Docks                11. The Unnamable        12. Unvisited Isle".colorize(:green)
	puts "13. Silver Twilight Lodge      14. Inner Sanctum        15. The Witch House".colorize(:light_blue)
	puts "16. Black Cave                 17. General Store        18. Graveyard".colorize(:blue)
	puts "19. Hibb's Roadhouse           20. Police Station       21. Velma's Diner".colorize(:white)
	puts "22. Historical Society         23. Ma's Boarding House  24. South Church".colorize(:yellow)
	puts "25. Arkham Asylum              26. Bank of Arkham       27. Independence Square".colorize(:light_white)
	puts "-------------------------------------------------------------------------------------------------------------"
	puts "Select a number...        (Ctrl + c to quit)"
	puts "-------------------------------------------------------------------------------------------------------------"
	input = gets.chomp.to_i
	if input == 1
		puts "St. Mary's Hospital"
		puts "-------------------"
		puts stMarys[rand(stMarys.size)]
	elsif input == 2
		puts "Woods"
		puts "-------------------"
		puts woods[rand(woods.size)]
	elsif input == 3
		puts "Ye Olde Magick Shoppe"
		puts "-------------------"
		puts magick[rand(magick.size)]
	elsif input == 4
		puts "Curiositie Shoppe"
		puts "-------------------"
		puts curiositie[rand(curiositie.size)]
	elsif input == 5
		puts "Newspaper"
		puts "-------------------"
		puts newspaper[rand(newspaper.size)]
	elsif input == 6
		puts "Train Station"
		puts "-------------------"
		puts train[rand(train.size)]
	elsif input == 7
		puts "Administrative Building"
		puts "-------------------"
		puts admin[rand(admin.size)]
	elsif input == 8
		puts "Library"
		puts "-------------------"
		puts library[rand(library.size)]
	elsif input == 9
		puts "Science Building"
		puts "-------------------"
		puts science[rand(science.size)]
	elsif input == 10
		puts "River Docks"
		puts "-------------------"
		puts docks[rand(docks.size)]
	elsif input == 11
		puts "The Unnameable"
		puts "-------------------"
		puts unnameable[rand(unnameable.size)]
	elsif input == 12
		puts "Unvisited Isle"
		puts "-------------------"
		puts unvisited[rand(unvisited.size)]
	elsif input == 13
		puts "Silver Twilight Lodge"
		puts "-------------------"
		puts lodge[rand(lodge.size)]
	elsif input == 14
		puts "Inner Sanctum"
		puts "-------------------"
		puts inner[rand(inner.size)]
	elsif input == 15
		puts "The Witch House"
		puts "-------------------"
		puts witch[rand(witch.size)]
	elsif input == 16
		puts "Black Cave"
		puts "-------------------"
		puts cave[rand(cave.size)]
	elsif input == 17
		puts "General Store"
		puts "-------------------"
		puts general[rand(general.size)]
	elsif input == 18
		puts "Graveyard"
		puts "-------------------"
		puts graveyard[rand(graveyard.size)]
	elsif input == 19
		puts "Hibb's Roadhouse"
		puts "-------------------"
		puts hibbs[rand(hibbs.size)]
	elsif input == 20
		puts "Police Station"
		puts "-------------------"
		puts police[rand(police.size)]
	elsif input == 21
		puts "Velma's Diner"
		puts "-------------------"
		puts velma[rand(velma.size)]
	elsif input == 22
		puts "Historical Society"
		puts "-------------------"
		puts historical[rand(historical.size)]
	elsif input == 23
		puts "Ma's Boarding House"
		puts "-------------------"
		puts boarding[rand(boarding.size)]
	elsif input == 24
		puts "South Church"
		puts "-------------------"
		puts church[rand(church.size)]
	elsif input == 25
		puts "Arkham Asylum"
		puts "-------------------"
		puts asylum[rand(asylum.size)]
	elsif input == 26
		puts "Bank of Arkham"
		puts "-------------------"
		puts bank[rand(bank.size)]
	elsif input == 27
		puts "Independence Square"
		puts "-------------------"
		puts independence[rand(independence.size)]
